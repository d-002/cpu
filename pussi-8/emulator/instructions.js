...
const funcs = {
    ...
    COND: (_, v, ___, ____) => "COND -- SR & " + (v - (v & 1)) + ((v & 1) ? "(invert)" : "") + " -> CB",
    JUMPI: (_, v, ___, ____) => "JUMPI -- " + v,
    JUMP: (_, __, a, b) => "JUMP -- (r" + a + " << 8) + r" + b,
    JUMPR: (_, __, a, b) => "JUMPR -- (r" + a + " << 8) + r" + b,
    ...
    IN: (_, __, d, s) => "IN -- E(r" + s + ") -> R(r" + d + ")",
    OUT: (_, __, s, d) => "OUT -- R(r" + s + ") -> E(r" + d + ")",
    OR: (_, __, a, b) => "OR -- r" + a + " | " + b + " -> r0, set SR",
    NOR: (_, __, a, b) => "NOR -- !(r" + a + " | " + b + ") -> r0, set SR",
    ADD: (_, __, a, b) => "ADD -- r" + a + " + r" + b + " -> r0, set SR",
    SUB: (_, __, a, b) => "SUB -- r" + a + " - r" + b + " -> r0, set SR",
    XOR: (_, __, a, b) => "XOR -- r" + a + " ^ r" + b + " -> r0, set SR",
    XNOR: (_, __, a, b) => "XNOR -- !(r" + a + " ^ r" + b + ") -> r0, set SR",
    AND: (_, __, a, b) => "AND -- r" + a + " & r" + b + " -> r0, set SR",
    NAND: (_, __, a, b) => "NAND -- !(r" + a + " & r" + b + ") -> r0, set SR",
