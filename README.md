...
This README is in inverse chronological order.
...
- I/O
    ...
    - 2 additional reserved output ports (for the ALU buffer and state register)
    - PC readable from the outside
    - Plug-in external ROM (see ROM section)
    - External program counter display
...
- Computing
    ...
    - Built-in 32-bits timer, counts operations, individually readable bytes
- Misc
    - Word size of 8 bits
...
- I/O
    ...
    - Start stop buttons, reset, full reset, clock pulse output
- Computing
